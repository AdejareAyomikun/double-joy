    ...
    <div className="bg-white min-h-screen p-4 sm:p-10 font-sans text-[#360212]">
      ...
      <div className="max-w-4xl mx-auto mb-8 flex justify-between items-center print:hidden">
        <button 
          ...
          className="text-[10px] uppercase tracking-widest font-bold flex items-center gap-2 opacity-60 hover:opacity-100"
        >
      ...
      {/* Main Invoice Card */}
      <div className="max-w-4xl mx-auto border-[1px] border-[#fcf9f6] shadow-2xl p-8 sm:p-16 relative overflow-hidden">
        {/* Visual Brand Accent */}
        ...
        <div className="mt-24 text-center">
          <div className="flex items-center gap-4 mb-4 justify-center opacity-20">
            <div className="h-[1px] bg-[#360212] flex-1"></div>
            <Scissors size={14} />
            <div className="h-[1px] bg-[#360212] flex-1"></div>
          </div>
