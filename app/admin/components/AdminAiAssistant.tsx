    ...
    <div className="mt-3 max-w-3xl md:max-w-2xl bg-[#360212] py-3 px-2 md:px-8 text-white shadow-2xl border-l-4 border-[#fe5457]">
      ...
      <div className="flex gap-1 overflow-hidden">
        <input
          ...
          className="basis-[75%] px-2 md:px-4 py-3 bg-white/5 border border-white/10 focus:border-[#fe5457] focus:bg-white/10 outline-none text-sm transition-all placeholder:text-white/20"
        />
        <button
          onClick={handleAction}
          disabled={loading}
          className="basis-[25%] bg-[#fe5457] px-2 md:px-4 py-3 hover:bg-[#9f002b] transition-colors flex items-center justify-center md:min-w-25 disabled:opacity-50"
        >
