...
import { CreditCard, MapPin, ShoppingBag, Loader2 } from "lucide-react"; // Added Loader2
...
export default function CheckoutPage() {
  ...
  const { cart, loading: cartLoading } = useCart(); // Destructured cartLoading from context

  const [address, setAddress] = useState("");
  const [city, setCity] = useState("");
  const [state, setState] = useState("");
  const [isSubmitting, setIsSubmitting] = useState(false); // Added submission loading state
    ...
    return (
      <>
        <div className="bg-[#fcf9f6] min-h-screen">
          <Header />
          <div className="flex flex-col items-center justify-center py-40 font-sans text-[#89547c]">
            <Loader2 className="animate-spin text-[#fe5457] mx-auto mb-4" size={40} />
            <p className="font-serif italic text-[#89547c]">Securing your session...</p>
          </div>
        </div>
        <Footer />
      </>
      ...
      <>
        <div className="bg-[#fcf9f6] min-h-screen">
          ...
          <div className="flex flex-col items-center justify-center py-40 font-sans text-[#89547c]">
            ...
            <button onClick={() => router.push('/')} className="mt-4 text-[#fe5457] font-bold underline">Continue Shopping</button>
          </div>
        </div>
        <Footer />
      </>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-10">
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-[#d791be]/30 p-4 focus:outline-none focus:ring-1 focus:ring-[#fe5457] transition-all disabled:opacity-50"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        disabled={isSubmitting}
                        className="w-full bg-white border border-[#d791be]/30 p-4 focus:outline-none focus:ring-1 focus:ring-[#fe5457] transition-all appearance-none disabled:opacity-50"
                      >
              ...
              <button
                ...
                className="w-full bg-[#fe5457] text-white py-5 font-bold uppercase tracking-[0.25em] text-sm hover:bg-[#9f002b] transition-all shadow-xl shadow-[#fe5457]/20 disabled:bg-[#d791be] disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
